    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50 p-4">
        <div className="card p-8 text-center max-w-sm w-full space-y-4">
          ...
          <div>
            <h2 className="text-lg font-semibold text-slate-900">Cadastro enviado!</h2>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50 p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-xl font-bold text-slate-900">Cadastro de técnico</h1>
          <p className="text-sm text-slate-500 mt-1">Preencha para solicitar acesso ao sistema</p>
        </div>
